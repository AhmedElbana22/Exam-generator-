...
<style>
  ...
  .nav-bar span { color: #a78bfa; font-weight: 600; }
...
defaults = {
    ...
    "extracted_topics":       [],
    "feedback_state":         None,   # {"is_correct": bool, "answer": str, "explanation": str}
    "answered_questions":     [],     # history for back-navigation
}
...
with st.sidebar:
    ...
    st.markdown('<div class="sidebar-tagline">Adaptive AI Quiz Engine</div>', unsafe_allow_html=True)
    st.markdown("---")
    ...
    st.markdown(f"**Current Page:** {page_labels.get(cur,'')}")
